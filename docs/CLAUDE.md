...
- Иврит (HE): **Rubik** (Google Fonts, sans-serif) — и заголовки, и текст

> ⚠️ **ПРАВИЛО ШРИФТОВ — НЕЛЬЗЯ НАРУШАТЬ:**
> Шрифт иврита (`Rubik`) менять ЗАПРЕЩЕНО ни при каких обстоятельствах,
> если только сам Влад явно не попросил об этом в сообщении.
> Frank Ruhl Libre и Heebo — удалены намеренно (выглядели "религиозно").
> Rubik — финальное решение, согласованное с владельцем.
